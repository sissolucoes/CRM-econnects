 ...
 * Class Idiomas
 *
 * @property Idioma_Model $current_model
 *
 */
class Idiomas extends Admin_Controller {
    ...
    public function __construct(){
        ...
        $this->template->set('page_title', 'Idioma');
        $this->template->set_breadcrumb('Idioma', base_url("$this->controller_uri/index"));

        $this->load->model('idioma_model', 'current_model');
