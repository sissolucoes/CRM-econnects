 ...
 * Class Cms_Slides
 *
 * @property Cms_Slide_Model $current_model
 *
 */
class Cms_Slides extends Admin_Controller {
    ...
    public function __construct(){
        ...
        $this->template->set('page_title', 'Slides');
        $this->template->set_breadcrumb('Slides', base_url("$this->controller_uri/index"));

        $this->load->model('cms_slide_model', 'current_model');
