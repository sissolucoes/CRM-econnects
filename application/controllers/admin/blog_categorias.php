...
class Blog_Categorias extends Admin_Controller {
    ...
    public function __construct(){
        ...
        $this->template->set('page_title', 'Blog - Categorias');
        $this->template->set_breadcrumb('Blog - Categorias', base_url("$this->controller_uri/index"));

        $this->load->model('blog_categoria_model', 'current_model');
    ...
    public function add()
    {
        ...
        $data['categoria_parents'] = $this->current_model->get_parents(0);
    ...
    public function edit($id)
    {
        ...
        $data['primary_key'] = $this->current_model->primary_key();
        $data['idiomas'] =$idomas;
        $data['idiomas_rows'] = $this->blog_categoria_idioma->get_by_blog_categoria($id);
