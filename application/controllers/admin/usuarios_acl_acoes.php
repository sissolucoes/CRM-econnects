 ...
 *
 * @property Usuario_Acl_Acao_Model $current_model
 *
 */
class Usuarios_Acl_Acoes extends Admin_Controller {
    ...
    public function __construct(){
        ...
        $this->template->set('page_title', 'Ações');
        $this->template->set_breadcrumb('Ações', base_url("$this->controller_uri/index"));

        $this->load->model('usuario_acl_acao_model', 'current_model');
