 ...
 * Class Cms_Banners
 *
 * @property Cms_Banner_Model $current_model
 *
 */
class Cms_Banners extends Admin_Controller {
    ...
    public function __construct(){
        ...
        $this->template->set('page_title', 'Banners');
        $this->template->set_breadcrumb('Blocos', base_url("$this->controller_uri/index"));

        $this->load->model('cms_banner_model', 'current_model');
    ...
    public function edit($id)
    {
        ...
        $data['primary_key'] = $this->current_model->primary_key();
        $data['idiomas'] =$idomas;
        $data['idiomas_rows'] = $this->cms_banner_idioma->get_by_banner($id);
