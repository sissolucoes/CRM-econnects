            ...
            <div class="col-separator col-unscrollable bg-none box col-separator-first">
                ...
                <div class="col-table">
                    ...
                    <div class="innerAll  bg-white">
                            ...
                            <a href="<?php echo base_url("{$current_controller_uri}/view/{$cms_slide_id}")?>" class="btn  btn-app btn-primary">
                    ...
                    <div class="col-table-row">
                        ...
                        <div class="col-app col-unscrollable">
                            ...
                            <div class="col-app">
                                ...
                                <!-- Form -->
                                <form class="form-horizontal margin-none" id="validateSubmitForm" method="post"  enctype="multipart/form-data">
                                    <input type="hidden" name="<?php echo $primary_key ?>" value="<?php if (isset($row[$primary_key])) echo $row[$primary_key]; ?>"/>
                                    <input type="hidden" name="new_record" value="<?php echo $new_record; ?>"/>
                                    <input type="hidden" name="cms_slide_id" value="<?php echo  $cms_slide_id; ?>"/>
                                    <!-- Widget -->
                                    <div class="widget">
                                        ...
                                        <div class="widget-body innerAll inner-2x">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php $field_name = 'url';?>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">URL</label>
                                                        <div class="col-md-8"><input class="form-control" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>
                                                                        ...
                                                                        <div id="idioma-<?php echo $idioma['codigo'];?>" class="tab-pane <? if($c == 0) echo 'active';?> widget-body-regular">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-8">
                                                                                        <input type="hidden" name="idiomas[<?php echo $idioma['idioma_id'];?>][<?php echo $field_name;?>]" value="<?php echo isset($idioma_row[$field_name]) ? $idioma_row[$field_name] : set_value($field_name); ?>"/>
                                                                                        <input type="file" id="imagem_<?php echo $idioma['idioma_id']?>" name="imagem_<?php echo $idioma['idioma_id']?>" />
