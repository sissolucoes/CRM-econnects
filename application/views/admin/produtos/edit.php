                                        ...
                                        <div class="widget-body innerAll inner-2x">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php $field_name = 'modelo_pagina';?>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Modelo</label>
                                                        <div class="col-md-4">
                                                    ...
                                                    <?php $field_name = 'url_frame';?>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">URL do Frame</label>
                                                        <div class="col-md-8"><input class="form-control" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>

                                                    <?php $field_name = 'produto_categoria_id';?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            <select class="form-control required" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>">
                                                                <option></option>
                                                                <?php foreach($produto_categorias as $item): ?>
