            ...
            <div class="col-separator col-unscrollable bg-none box col-separator-first">
                ...
                <div class="col-table">
                    ...
                    <div class="innerAll  bg-white">
                            ...
                            <a href="<?php echo base_url("{$current_controller_uri}/view/{$cms_menu_id}")?>" class="btn  btn-app btn-primary">
                        ...
                        <div class="col-app col-unscrollable">
                            ...
                            <div class="col-app">
                                ...
                                <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off">
                                    ...
                                    <input type="hidden" name="cms_menu_id" value="<?php echo  $cms_menu_id; ?>"/>
                                    <!-- Widget -->
                                    <div class="widget">
                                        ...
                                        <div class="widget-body innerAll inner-2x">
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php $field_name = 'cms_menu_item_parent_id';?>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select  class="form-control required" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                                                ...
                                                                <?php app_display_options_menu_item($menu_item_parents, 1, isset($row[$field_name]) ? $row[$field_name] : 0,  isset($row[$primary_key]) ? $row[$primary_key] : 0  ) ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Target</label>
                                                        <div class="col-md-4">
                                                            <select  class="form-control required" name="<?php echo $field_name;?>" id="<?php echo $field_name;?>">
                                                                <option></option>
                                                                <?php foreach(array( '_blank' => 'Nova janela', '_self' => 'Mesma página') as $item_value => $item_name) :?>
                                                                    <option value="<?php echo $item_value;?>" <?php  if(isset($row[$field_name]) && $row[$field_name] == $item_value) echo 'selected="selected"'; ?>><?php echo $item_name;?></option>
                                                                <?php endforeach;?>
                                                            </select>
                                                        </div>
