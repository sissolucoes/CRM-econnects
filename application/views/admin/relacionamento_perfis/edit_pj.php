            ...
            <div class="col-separator col-unscrollable bg-none box col-separator-first">
                ...
                <div class="col-table">
                    ...
                    <div class="innerAll  bg-white">
                            ...
                            <a href="<?php echo base_url("{$current_controller_uri}/view/{$relacionamento_usuario_id}")?>" class="btn  btn-app btn-primary">
                    ...
                    <div class="col-table-row">
                        ...
                        <div class="col-app col-unscrollable">
                            ...
                            <div class="col-app">
                                ...
                                <!-- Form -->
                                <form class="form-horizontal margin-none" id="validateSubmitForm" method="post" autocomplete="off" action="<?php echo $form_action;?>">
                                    <input type="hidden" name="<?php echo $primary_key ?>" value="<?php if (isset($row[$primary_key])) echo $row[$primary_key]; ?>"/>
                                    <input type="hidden" name="new_record" value="<?php echo $new_record; ?>"/>
                                    <input type="hidden" name="relacionamento_usuario_id" value="<?php echo $relacionamento_usuario_id; ?>"/>
                                            ...
                                            <div class="row innerLR">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">Nome Fantasia</label>
                                                    ...
                                                    <?php $field_name = 'cnpj';?>
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label" for="<?php echo $field_name;?>">CNPJ</label>
                                                        <div class="col-md-8"><input class="form-control" id="<?php echo $field_name;?>" name="<?php echo $field_name;?>" type="text" value="<?php echo isset($row[$field_name]) ? $row[$field_name] : set_value($field_name); ?>" /></div>
                                                    </div>
