<?php
Class Blog_Categoria_Model extends MY_Model
{

    protected $_table = 'blog_categoria';
    protected $primary_key = 'blog_categoria_id';
    ...
    public function get_form_data(){
        ...
        $data =  array(
            ...
            'blog_categoria_parent_id' => 0 //defaut
        );
    ...
    public function insert_form(){
        ...
        $this->load->model('blog_categoria_idioma_model', 'blog_categoria_idioma');
        ...
        $blog_categoria_id =  $this->insert($data);

        $this->blog_categoria_idioma->insert_by_blog_categoria($blog_categoria_id, $idiomas);

        return $blog_categoria_id;
    ...
    public function update_form(){
        ...
        $blog_categoria_id = $this->input->post($this->primary_key);

        $this->update( $blog_categoria_id,  $data);
    ...
    function get_blog_categoria_by_slug($slug){

        return $this->get_by('slug', $slug);

    }
    function get_blog_categoria_by_id($id){
    ...
    public function with_idioma(){
        ...
        $with_table = 'blog_categoria_idioma';
        $prefix = '';
    ...
    public function get_filhos_of($pai){
        ...
        $this->_database->where('blog_categoria_parent_id', $pai);
        return $this->get_all();
